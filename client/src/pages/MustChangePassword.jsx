    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          <div className="flex items-start gap-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-4 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-amber-700 dark:text-amber-400 mt-1">
                Your account was set up by an administrator. You must change your password before you can access the portal.
              </p>
            </div>
          </div>
          ...
          <button
            onClick={logout}
            className="w-full text-center text-sm text-gray-400 dark:text-slate-500 hover:text-red-500 mt-4"
          >
            Sign out
          </button>
        </div>
