      ...
      <div className="w-full max-w-lg">
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm p-10 text-center">
          ...
          <p className="text-gray-500 dark:text-slate-400 text-sm leading-relaxed mb-8">
            Thank you for registering with Yachal House. Your account has been received and is currently being reviewed by our admin team. You will receive an email notification once your account is approved.
          </p>

          <div className="bg-gray-50 dark:bg-slate-900 rounded-xl p-5 text-left space-y-4 mb-8">
            <p className="text-xs font-semibold text-gray-400 dark:text-slate-500 uppercase tracking-wider mb-3">What happens next</p>
            {[
              "Our admin team reviews your registration",
              "Your account is approved and a Worker ID is assigned to you",
              "You receive an email with your Worker ID and access details",
              "You can then sign in and start using the portal",
            ].map((step, i) => (
          ...
          <div className="space-y-3 mb-8">
            <p className="text-xs font-semibold text-gray-400 dark:text-slate-500 uppercase tracking-wider">Need help? Contact us</p>
            <a href="tel:+233544600600" className="flex items-center justify-center gap-2 text-sm text-gray-600 dark:text-slate-300 hover:text-purple-700 dark:hover:text-purple-400 transition-colors">
              <Phone className="w-4 h-4" />
              +233 544 600 600
            </a>
            <a href="mailto:yachalhouse@gmail.com" className="flex items-center justify-center gap-2 text-sm text-gray-600 dark:text-slate-300 hover:text-purple-700 dark:hover:text-purple-400 transition-colors">
